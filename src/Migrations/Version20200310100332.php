...
final class Version20200310100332 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE user ADD avatar VARCHAR(50) DEFAULT NULL, CHANGE roles roles JSON NOT NULL, CHANGE date_of_birth date_of_birth DATE DEFAULT NULL, CHANGE verification_token verification_token VARCHAR(150) DEFAULT NULL, CHANGE locale locale VARCHAR(10) DEFAULT NULL');
    }
